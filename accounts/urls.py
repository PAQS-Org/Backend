...
from .views import CompanyRegistrationView, LogoutAPIView, SetNewPasswordAPIView, EmailVerificationView, CompanyLoginView
...
urlpatterns = [
    ...
    path('company-logout/', LogoutAPIView.as_view(), name="logout"),

# Generated by Django 4.2.16 on 2024-09-15 19:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_code', models.PositiveIntegerField(blank=True, null=True, unique=True)),
            ],
            options={
                'verbose_name': 'Company',
                'verbose_name_plural': 'Companies',
                'indexes': [models.Index(fields=['company_code'], name='accounts_co_company_6be2b7_idx')],
            },
            bases=('accounts.abstractuserprofile',),
        ),
    ]
